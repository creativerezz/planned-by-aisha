import { HERO_COPY, type HeroCopy } from "./hero-copy";

const HERO_EYEBROW = "%%HERO_EYEBROW%%";
const HERO_TITLE = "%%HERO_TITLE%%";
const HERO_BODY = "%%HERO_BODY%%";

export const homeHtmlTemplate = `<div class="hon-root" style="background:var(--wine);color:var(--ivory);font-family:var(--font-body);font-size:18px;line-height:1.65;-webkit-font-smoothing:antialiased;overflow-x:hidden;position:relative">
  ...
  <header id="hon-header" style="position:fixed;top:0;left:0;right:0;z-index:100;display:flex;align-items:center;justify-content:space-between;padding:1.45rem clamp(1.25rem,5vw,4rem);border-bottom:1px solid transparent;transition:background .5s var(--ease),padding .5s var(--ease),border-color .5s var(--ease)">
    <a href="#hon-top" style="font-family:var(--font-display);font-weight:400;font-size:1.16rem;letter-spacing:.05em;display:inline-flex;align-items:baseline;gap:.15em">Planned<span style="font-style:italic;font-size:.78em;letter-spacing:.06em;opacity:.78;margin:0 .12em">by</span>Ayesha</a>
    <nav id="hon-nav" class="hon-nav" style="display:flex;align-items:center;gap:2.2rem;position:relative">
      <div class="hon-nav-links">
        <a href="#hon-top"     onclick="closeMenu()" class="nav-link" style="font-family:var(--font-ui);font-size:.74rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(244,234,217,.74);transition:color .35s">Home</a>
        <a href="#hon-work"    onclick="closeMenu()" class="nav-link" style="font-family:var(--font-ui);font-size:.74rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(244,234,217,.74);transition:color .35s">Portfolio</a>
        <a href="#hon-process" onclick="closeMenu()" class="nav-link" style="font-family:var(--font-ui);font-size:.74rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(244,234,217,.74);transition:color .35s">Services</a>
        <a href="#hon-inquire" onclick="closeMenu()" class="nav-link" style="font-family:var(--font-ui);font-size:.74rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(244,234,217,.74);transition:color .35s">Contact</a>
      </div>
      <a href="#hon-inquire" onclick="closeMenu()" class="hon-nav-cta nav-cta" style="font-family:var(--font-ui);font-size:.72rem;letter-spacing:.18em;text-transform:uppercase;border:1px solid var(--line);padding:.7em 1.4em;transition:border-color .4s,color .4s">Inquire</a>
      <button class="hon-menu-toggle" onclick="toggleMenu()" aria-label="Toggle menu" style="background:none;border:none;color:var(--ivory);font-family:var(--font-ui);font-size:.74rem;letter-spacing:.18em;text-transform:uppercase;cursor:pointer;display:inline-flex;align-items:center;padding:0">Menu</button>
    </nav>
  </header>
  ...
  <section id="hon-top" style="position:relative;min-height:100svh;display:flex;flex-direction:column;justify-content:flex-start;padding:8.5rem clamp(1.25rem,5vw,4rem) 3rem;background:radial-gradient(120% 90% at 12% 6%, #6c2129 0%, var(--wine) 44%, var(--wine-deep) 100%);overflow:hidden">
    ...
    <div class="hon-hero-grid" style="position:relative;z-index:2;width:100%;max-width:1240px;margin:0 auto">
      ...
      <div>
        <div class="reveal" style="display:flex;align-items:center;gap:1rem;margin-bottom:2rem">
          ...
          <span style="font-family:var(--font-ui);font-weight:500;font-size:.72rem;letter-spacing:.32em;text-transform:uppercase;color:var(--brass)">${HERO_EYEBROW}</span>
        </div>
        <h1 class="reveal d1" style="font-family:var(--font-display);font-weight:400;font-size:clamp(3rem,8vw,6.4rem);line-height:1.0;letter-spacing:-.02em;margin-bottom:1.8rem;text-wrap:balance">${HERO_TITLE}</h1>
        <p class="reveal d2" style="font-size:clamp(1.08rem,1.6vw,1.24rem);line-height:1.6;color:rgba(244,234,217,.82);max-width:38ch;margin-bottom:2.6rem">${HERO_BODY}</p>
        <div class="reveal d3" style="display:flex;align-items:center;gap:2rem;flex-wrap:wrap">
          <a href="#hon-inquire" class="btn-ivory" style="font-family:var(--font-ui);font-weight:400;font-size:.78rem;letter-spacing:.2em;text-transform:uppercase;display:inline-flex;align-items:center;gap:.7em;padding:1.05em 1.9em;border:1px solid var(--brass);color:var(--wine);background:var(--ivory);cursor:pointer;transition:background .5s var(--ease),color .5s var(--ease),letter-spacing .5s var(--ease)">Begin your inquiry <span>↗</span></a>
          <a href="#hon-work" class="btn-text" style="font-family:var(--font-ui);font-size:.78rem;letter-spacing:.2em;text-transform:uppercase;color:var(--ivory);border-bottom:1px solid var(--line);padding-bottom:.4em;transition:border-color .4s,color .4s">View portfolio</a>
        </div>
      </div>
      ...
      <div class="hon-hero-figure reveal d2" style="position:relative;padding:.5rem;border:1px solid var(--line)">
        ...
        <span style="position:absolute;left:1.3rem;bottom:1.3rem;z-index:3;font-family:var(--font-ui);font-size:.64rem;letter-spacing:.22em;text-transform:uppercase;color:var(--ivory);background:rgba(53,12,20,.55);backdrop-filter:blur(4px);padding:.55em .9em;border:1px solid var(--line)">Walima mood · burgundy &amp; gold</span>
      </div>
    </div>
    ...
    <div class="reveal d4" style="position:relative;z-index:2;width:100%;max-width:1240px;margin:clamp(2.5rem,5vw,3.5rem) auto 0;border-top:1px solid var(--line);padding-top:1.5rem;display:flex;flex-wrap:wrap;gap:.8rem 2.2rem;align-items:center">
      <span style="font-family:var(--font-ui);font-size:.72rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(244,234,217,.62)">Weddings</span><span style="color:var(--brass);opacity:.8">✦</span>
      <span style="font-family:var(--font-ui);font-size:.72rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(244,234,217,.62)">Walimas</span><span style="color:var(--brass);opacity:.8">✦</span>
      <span style="font-family:var(--font-ui);font-size:.72rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(244,234,217,.62)">Engagements</span><span style="color:var(--brass);opacity:.8">✦</span>
      <span style="font-family:var(--font-ui);font-size:.72rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(244,234,217,.62)">Mehndis</span><span style="color:var(--brass);opacity:.8">✦</span>
      <span style="font-family:var(--font-ui);font-size:.72rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(244,234,217,.62)">Private dinners</span>
    </div>
  </section>
  ...
  <section style="background:var(--parchment);color:var(--wine);padding:clamp(5rem,11vw,9rem) clamp(1.25rem,5vw,4rem);position:relative">
    <div class="hon-founder-grid" style="max-width:1240px;margin:0 auto">
      ...
      <div>
        <span class="reveal" style="font-family:var(--font-ui);font-weight:500;font-size:.72rem;letter-spacing:.32em;text-transform:uppercase;color:#9a6b3e">The founder</span>
        <h2 class="reveal d1" style="font-family:var(--font-display);font-weight:400;font-size:clamp(2.4rem,5vw,4rem);line-height:1.05;letter-spacing:-.02em;color:var(--wine);margin:.5rem 0 1.6rem">I'm <em class="hon-em" style="color:#9a6b3e">Ayesha.</em></h2>
        ...
        <div class="reveal d2" style="margin-top:2.2rem;padding-top:2.2rem;border-top:1px solid rgba(86,23,31,.2)">
          <span style="display:block;font-family:var(--font-ui);font-weight:500;font-size:.72rem;letter-spacing:.32em;text-transform:uppercase;color:#9a6b3e;margin-bottom:.8rem">Our vision</span>
          <p style="font-family:var(--font-display);font-style:italic;font-size:clamp(1.2rem,2.2vw,1.4rem);line-height:1.5;color:var(--wine);max-width:42ch">To gather people through experiences made with genuine care — where every guest feels welcomed, present, and truly seen.</p>
        </div>
        <div class="reveal d3" style="margin-top:2.4rem">
          <a href="#hon-process" class="btn-wine" style="font-family:var(--font-ui);font-weight:400;font-size:.78rem;letter-spacing:.2em;text-transform:uppercase;display:inline-flex;align-items:center;gap:.7em;padding:1.05em 1.9em;border:1px solid var(--wine);color:var(--ivory);background:var(--wine);cursor:pointer;transition:background .5s var(--ease),color .5s var(--ease),letter-spacing .5s var(--ease)">How we work together <span>↗</span></a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="hon-work" style="background:var(--oxblood);padding:clamp(5rem,11vw,9rem) clamp(1.25rem,5vw,4rem);position:relative">
    <div style="max-width:1240px;margin:0 auto">
      <div style="display:flex;align-items:baseline;justify-content:space-between;gap:2rem;flex-wrap:wrap;margin-bottom:clamp(2.5rem,5vw,4rem)">
        <div>
          <span class="reveal" style="font-family:var(--font-ui);font-weight:500;font-size:.72rem;letter-spacing:.32em;text-transform:uppercase;color:var(--brass)">Selected work</span>
          <h2 class="reveal d1" style="font-family:var(--font-display);font-weight:400;font-size:clamp(2.2rem,5vw,3.6rem);line-height:1.04;letter-spacing:-.02em;margin-top:.5rem">Recent celebrations.</h2>
        </div>
      ...
      <div class="hon-gallery">
        <div class="hon-tile hon-t-lg reveal" style="border:1px solid var(--line)">
          ...
          <span style="position:absolute;left:1.1rem;bottom:1rem;z-index:2;pointer-events:none"><span style="display:block;font-family:var(--font-ui);font-size:.6rem;letter-spacing:.24em;text-transform:uppercase;color:var(--brass-soft);margin-bottom:.35em">Stages &amp; decor</span><span style="font-family:var(--font-display);font-size:1.05rem">Walima stage</span></span>
        </div>
        <div class="hon-tile hon-t-sm reveal d1" style="border:1px solid var(--line)">
          ...
          <div class="tile-scrim" style="position:absolute;inset:0;background:linear-gradient(to top,rgba(53,12,20,.66),transparent 46%);z-index:1;pointer-events:none;opacity:.7"></div>
          <span style="position:absolute;left:1.1rem;bottom:1rem;z-index:2;pointer-events:none"><span style="display:block;font-family:var(--font-ui);font-size:.6rem;letter-spacing:.24em;text-transform:uppercase;color:var(--brass-soft);margin-bottom:.35em">Tablescapes</span><span style="font-family:var(--font-display);font-size:1.05rem">Centerpieces</span></span>
        </div>
        <div class="hon-tile hon-t-sm reveal" style="border:1px solid var(--line)">
          ...
          <div class="tile-scrim" style="position:absolute;inset:0;background:linear-gradient(to top,rgba(53,12,20,.66),transparent 46%);z-index:1;pointer-events:none;opacity:.7"></div>
          <span style="position:absolute;left:1.1rem;bottom:1rem;z-index:2;pointer-events:none"><span style="display:block;font-family:var(--font-ui);font-size:.6rem;letter-spacing:.24em;text-transform:uppercase;color:var(--brass-soft);margin-bottom:.35em">Paper &amp; favors</span><span style="font-family:var(--font-display);font-size:1.05rem">Custom signage</span></span>
        </div>
        <div class="hon-tile hon-t-lg reveal d1" style="border:1px solid var(--line)">
          ...
          <div class="tile-scrim" style="position:absolute;inset:0;background:linear-gradient(to top,rgba(53,12,20,.66),transparent 46%);z-index:1;pointer-events:none;opacity:.7"></div>
          <span style="position:absolute;left:1.1rem;bottom:1rem;z-index:2;pointer-events:none"><span style="display:block;font-family:var(--font-ui);font-size:.6rem;letter-spacing:.24em;text-transform:uppercase;color:var(--brass-soft);margin-bottom:.35em">Tablescapes</span><span style="font-family:var(--font-display);font-size:1.05rem">Banquet reception</span></span>
        </div>
        <div class="hon-tile hon-t-third reveal" style="border:1px solid var(--line)">
          ...
          <div class="tile-scrim" style="position:absolute;inset:0;background:linear-gradient(to top,rgba(53,12,20,.66),transparent 46%);z-index:1;pointer-events:none;opacity:.7"></div>
          <span style="position:absolute;left:1.1rem;bottom:1rem;z-index:2;pointer-events:none"><span style="display:block;font-family:var(--font-ui);font-size:.6rem;letter-spacing:.24em;text-transform:uppercase;color:var(--brass-soft);margin-bottom:.35em">Stages &amp; decor</span><span style="font-family:var(--font-display);font-size:1.05rem">Candlelit setting</span></span>
        </div>
        <div class="hon-tile hon-t-third reveal d1" style="border:1px solid var(--line)">
          ...
          <div class="tile-scrim" style="position:absolute;inset:0;background:linear-gradient(to top,rgba(53,12,20,.66),transparent 46%);z-index:1;pointer-events:none;opacity:.7"></div>
          <span style="position:absolute;left:1.1rem;bottom:1rem;z-index:2;pointer-events:none"><span style="display:block;font-family:var(--font-ui);font-size:.6rem;letter-spacing:.24em;text-transform:uppercase;color:var(--brass-soft);margin-bottom:.35em">Vendor spotlight</span><span style="font-family:var(--font-display);font-size:1.05rem">Floral photobooth</span></span>
        </div>
        <div class="hon-tile hon-t-third reveal d2" style="border:1px solid var(--line)">
          ...
          <div class="tile-scrim" style="position:absolute;inset:0;background:linear-gradient(to top,rgba(53,12,20,.66),transparent 46%);z-index:1;pointer-events:none;opacity:.7"></div>
          <span style="position:absolute;left:1.1rem;bottom:1rem;z-index:2;pointer-events:none"><span style="display:block;font-family:var(--font-ui);font-size:.6rem;letter-spacing:.24em;text-transform:uppercase;color:var(--brass-soft);margin-bottom:.35em">Vendor spotlight</span><span style="font-family:var(--font-display);font-size:1.05rem">Coffee &amp; matcha bar</span></span>
        </div>
      </div>

      <div class="reveal" style="margin-top:clamp(2.5rem,5vw,3.5rem);display:flex;justify-content:center">
        <a href="#hon-inquire" class="btn-text" style="font-family:var(--font-ui);font-size:.78rem;letter-spacing:.2em;text-transform:uppercase;color:var(--ivory);border-bottom:1px solid var(--line);padding-bottom:.4em;transition:border-color .4s,color .4s">Inquire about your celebration ↗</a>
      </div>
    </div>
  </section>
  ...
  <section id="hon-process" style="background:var(--emerald);padding:clamp(5rem,11vw,9rem) clamp(1.25rem,5vw,4rem);position:relative">
    <div style="max-width:1240px;margin:0 auto">
      <span class="reveal" style="font-family:var(--font-ui);font-weight:500;font-size:.72rem;letter-spacing:.32em;text-transform:uppercase;color:var(--brass-soft)">How we work</span>
      <h2 class="reveal d1" style="font-family:var(--font-display);font-weight:400;font-size:clamp(2.2rem,5vw,3.6rem);line-height:1.06;letter-spacing:-.02em;max-width:20ch;margin-top:.5rem">A logistics-led approach, so the day can feel entirely yours.</h2>

      <div class="hon-phases" style="margin-top:clamp(2.5rem,5vw,4rem)">
        <div class="reveal d1">
          <div style="font-family:var(--font-ui);font-size:.74rem;letter-spacing:.26em;text-transform:uppercase;color:var(--brass-soft);display:flex;align-items:center;gap:1rem;margin-bottom:1.1rem"><span>01 — Before</span><span style="height:1px;flex:1;background:var(--line)"></span></div>
          <h3 style="font-family:var(--font-display);font-weight:400;font-size:1.7rem;letter-spacing:-.01em;margin-bottom:.5rem">Pre-event coordination</h3>
        ...
        <div class="reveal d2">
          <div style="font-family:var(--font-ui);font-size:.74rem;letter-spacing:.26em;text-transform:uppercase;color:var(--brass-soft);display:flex;align-items:center;gap:1rem;margin-bottom:1.1rem"><span>02 — The day</span><span style="height:1px;flex:1;background:var(--line)"></span></div>
          <h3 style="font-family:var(--font-display);font-weight:400;font-size:1.7rem;letter-spacing:-.01em;margin-bottom:.5rem">Day-of execution</h3>
      ...
      <div style="margin-top:clamp(3.5rem,6vw,5rem);border-top:1px solid var(--line);padding-top:clamp(2.5rem,4vw,3.5rem)">
        <span class="reveal" style="display:block;font-family:var(--font-ui);font-weight:500;font-size:.72rem;letter-spacing:.32em;text-transform:uppercase;color:var(--brass-soft);margin-bottom:.7rem">Investment</span>
        ...
        <div class="hon-tiers">
          <div class="reveal d1 tier-card" style="border:1px solid var(--line);padding:clamp(1.8rem,3vw,2.6rem);background:rgba(53,12,20,.18)">
            <span style="font-family:var(--font-ui);font-size:.66rem;letter-spacing:.24em;text-transform:uppercase;color:var(--brass-soft)">i. Planning tier</span>
            <h3 style="font-family:var(--font-display);font-weight:400;font-size:1.5rem;margin:.7rem 0 1.1rem">Pre-event planning &amp; creation</h3>
            <div style="font-family:var(--font-display);font-size:2.4rem;color:var(--ivory);margin-bottom:1.4rem;letter-spacing:-.02em">$800<span style="font-size:1rem;color:rgba(244,234,217,.6);font-style:italic"> – $1,500</span></div>
            <ul style="list-style:none">
          ...
          <div class="reveal d2 tier-card" style="border:1px solid var(--line);padding:clamp(1.8rem,3vw,2.6rem);background:rgba(53,12,20,.18)">
            <span style="font-family:var(--font-ui);font-size:.66rem;letter-spacing:.24em;text-transform:uppercase;color:var(--brass-soft)">ii. Execution tier</span>
            <h3 style="font-family:var(--font-display);font-weight:400;font-size:1.5rem;margin:.7rem 0 1.1rem">Wedding-day execution</h3>
            <div style="font-family:var(--font-display);font-size:2.4rem;color:var(--ivory);margin-bottom:1.4rem;letter-spacing:-.02em">$500<span style="font-size:1rem;color:rgba(244,234,217,.6);font-style:italic"> – $1,200</span></div>
            <ul style="list-style:none">
  ...
  <section style="background:var(--wine-deep);text-align:center;position:relative;overflow:hidden;padding:clamp(5rem,11vw,9rem) clamp(1.25rem,5vw,4rem)">
    ...
    <div style="max-width:1240px;margin:0 auto;position:relative;z-index:2">
      <div class="reveal" style="font-family:var(--font-display);font-size:5rem;color:var(--brass);opacity:.55;line-height:.4;margin-bottom:1rem">"</div>
      <blockquote class="reveal d1" style="font-family:var(--font-display);font-weight:400;font-size:clamp(1.7rem,3.6vw,2.7rem);line-height:1.32;max-width:20ch;margin:0 auto 2rem;letter-spacing:-.01em">The whole evening was beautiful and felt <em class="hon-em" style="color:var(--brass-soft)">effortless.</em> I truly couldn't have imagined the day without her.</blockquote>
      <cite class="reveal d2" style="font-family:var(--font-ui);font-style:normal;font-size:.74rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(244,234,217,.7)">Sumaiya Farooq — Walima bride</cite>
    </div>
  </section>
  ...
  <section id="hon-inquire" style="background:radial-gradient(110% 100% at 50% 0%, #6c2129 0%, var(--wine) 46%, var(--oxblood) 100%);position:relative;overflow:hidden;padding:clamp(5rem,11vw,9rem) clamp(1.25rem,5vw,4rem)">
    ...
    <div class="hon-closing-grid" style="max-width:1080px;margin:0 auto;position:relative;z-index:2">
      <div>
        <span class="reveal" style="font-family:var(--font-ui);font-weight:500;font-size:.72rem;letter-spacing:.32em;text-transform:uppercase;color:var(--brass)">Let's begin</span>
        <h2 class="reveal d1" style="font-family:var(--font-display);font-weight:400;font-size:clamp(2.4rem,5.5vw,4rem);line-height:1.04;letter-spacing:-.02em;margin:1rem 0 1.5rem">Let's make something <em class="hon-em" style="color:var(--brass-soft)">beautiful</em> together.</h2>
        ...
        <div class="reveal d2" style="margin-top:2.6rem;padding-top:2rem;border-top:1px solid var(--line);display:flex;flex-direction:column;gap:.7rem">
          <a href="mailto:info@huesofnoor.com" class="contact-link" style="font-family:var(--font-body);font-size:1.05rem;color:rgba(244,234,217,.85);transition:color .35s"><span style="font-family:var(--font-ui);font-size:.62rem;letter-spacing:.22em;text-transform:uppercase;color:var(--brass);margin-right:.9rem">Email</span>info@huesofnoor.com</a>
          <a href="tel:5623412539" class="contact-link" style="font-family:var(--font-body);font-size:1.05rem;color:rgba(244,234,217,.85);transition:color .35s"><span style="font-family:var(--font-ui);font-size:.62rem;letter-spacing:.22em;text-transform:uppercase;color:var(--brass);margin-right:.9rem">Phone</span>562-341-2539</a>
          <a href="https://instagram.com/byhuesofnoor" target="_blank" rel="noopener" class="contact-link" style="font-family:var(--font-body);font-size:1.05rem;color:rgba(244,234,217,.85);transition:color .35s"><span style="font-family:var(--font-ui);font-size:.62rem;letter-spacing:.22em;text-transform:uppercase;color:var(--brass);margin-right:.9rem">Social</span>@byhuesofnoor</a>
        </div>
      </div>
      ...
      <div class="reveal d2" style="border:1px solid var(--line);padding:clamp(1.6rem,3.5vw,2.6rem);background:rgba(53,12,20,.28);backdrop-filter:blur(6px)">
        <form id="hon-form" onsubmit="handleSubmit(event)" novalidate>
          <span style="display:block;font-family:var(--font-ui);font-weight:500;font-size:.72rem;letter-spacing:.32em;text-transform:uppercase;color:var(--brass);margin-bottom:1.4rem">Tell us about your vision</span>
          <div style="margin-bottom:1.1rem">
            <label for="hon-name" style="display:block;font-family:var(--font-ui);font-size:.62rem;letter-spacing:.2em;text-transform:uppercase;color:rgba(244,234,217,.6);margin-bottom:.5rem">Full name</label>
            <input id="hon-name" name="name" type="text" class="hon-input" style="width:100%;background:transparent;border:none;border-bottom:1px solid var(--line);color:var(--ivory);font-family:var(--font-body);font-size:1.05rem;padding:.55rem 0;transition:border-color .4s">
          </div>
          <div class="hon-field-row">
            <div style="margin-bottom:1.1rem">
              <label for="hon-email" style="display:block;font-family:var(--font-ui);font-size:.62rem;letter-spacing:.2em;text-transform:uppercase;color:rgba(244,234,217,.6);margin-bottom:.5rem">Email</label>
              <input id="hon-email" name="email" type="email" class="hon-input" style="width:100%;background:transparent;border:none;border-bottom:1px solid var(--line);color:var(--ivory);font-family:var(--font-body);font-size:1.05rem;padding:.55rem 0;transition:border-color .4s">
            </div>
            <div style="margin-bottom:1.1rem">
              <label for="hon-phone" style="display:block;font-family:var(--font-ui);font-size:.62rem;letter-spacing:.2em;text-transform:uppercase;color:rgba(244,234,217,.6);margin-bottom:.5rem">Phone</label>
              <input id="hon-phone" name="phone" type="tel" class="hon-input" style="width:100%;background:transparent;border:none;border-bottom:1px solid var(--line);color:var(--ivory);font-family:var(--font-body);font-size:1.05rem;padding:.55rem 0;transition:border-color .4s">
            </div>
          </div>
          <div class="hon-field-row">
            <div style="margin-bottom:1.1rem">
              <label for="hon-type" style="display:block;font-family:var(--font-ui);font-size:.62rem;letter-spacing:.2em;text-transform:uppercase;color:rgba(244,234,217,.6);margin-bottom:.5rem">Event type</label>
              <select id="hon-type" name="type" class="hon-select" style="width:100%;background:transparent;border:none;border-bottom:1px solid var(--line);color:var(--ivory);font-family:var(--font-body);font-size:1.05rem;padding:.55rem 0;cursor:pointer;transition:border-color .4s;-webkit-appearance:none;appearance:none">
            ...
            <div style="margin-bottom:1.1rem">
              <label for="hon-date" style="display:block;font-family:var(--font-ui);font-size:.62rem;letter-spacing:.2em;text-transform:uppercase;color:rgba(244,234,217,.6);margin-bottom:.5rem">Event date</label>
              <input id="hon-date" name="date" type="text" placeholder="Approx." class="hon-input" style="width:100%;background:transparent;border:none;border-bottom:1px solid var(--line);color:var(--ivory);font-family:var(--font-body);font-size:1.05rem;padding:.55rem 0;transition:border-color .4s">
            </div>
          </div>
          <div style="margin-bottom:1.1rem">
            <label for="hon-vision" style="display:block;font-family:var(--font-ui);font-size:.62rem;letter-spacing:.2em;text-transform:uppercase;color:rgba(244,234,217,.6);margin-bottom:.5rem">Share your vision</label>
            <textarea id="hon-vision" name="vision" rows="2" class="hon-textarea" style="width:100%;background:transparent;border:none;border-bottom:1px solid var(--line);color:var(--ivory);font-family:var(--font-body);font-size:1.05rem;padding:.55rem 0;resize:vertical;min-height:64px;transition:border-color .4s"></textarea>
          </div>
          <button type="submit" class="btn-ivory" style="width:100%;justify-content:center;font-family:var(--font-ui);font-weight:400;font-size:.78rem;letter-spacing:.2em;text-transform:uppercase;display:inline-flex;align-items:center;gap:.7em;padding:1.05em 1.9em;border:1px solid var(--brass);color:var(--wine);background:var(--ivory);cursor:pointer;margin-top:.8rem;transition:background .5s var(--ease),color .5s var(--ease),letter-spacing .5s var(--ease)">Send inquiry <span>↗</span></button>
        ...
        <div id="hon-success" class="form-success">
          <div style="font-family:var(--font-display);font-size:2.6rem;color:var(--brass);margin-bottom:.6rem">✦</div>
          <h3 style="font-family:var(--font-display);font-weight:400;font-size:1.6rem;margin-bottom:.6rem">Thank you.</h3>
  ...
  <footer style="background:var(--oxblood);padding:clamp(3.5rem,7vw,5rem) clamp(1.25rem,5vw,4rem) 2.5rem;border-top:1px solid var(--line)">
    <div class="hon-foot-grid" style="max-width:1240px;margin:0 auto">
      <div>
        <span style="font-family:var(--font-display);font-weight:400;font-size:1.5rem;letter-spacing:.04em;display:inline-flex;align-items:baseline;gap:.15em;margin-bottom:1rem">Planned<span style="font-style:italic;font-size:.78em;letter-spacing:.06em;opacity:.78;margin:0 .12em">by</span>Ayesha</span>
        ...
        <span style="font-family:var(--font-ui);font-weight:500;font-size:.62rem;letter-spacing:.3em;text-transform:uppercase;color:var(--brass)">Event design · Los Angeles</span>
      </div>
      <div>
        <h4 style="font-family:var(--font-ui);font-weight:500;font-size:.66rem;letter-spacing:.24em;text-transform:uppercase;color:var(--brass);margin-bottom:1.2rem">Explore</h4>
      ...
      <div>
        <h4 style="font-family:var(--font-ui);font-weight:500;font-size:.66rem;letter-spacing:.24em;text-transform:uppercase;color:var(--brass);margin-bottom:1.2rem">Connect</h4>
    ...
    <div style="max-width:1240px;margin:3rem auto 0;padding-top:1.6rem;border-top:1px solid rgba(201,167,103,.16);display:flex;justify-content:space-between;flex-wrap:wrap;gap:.8rem;font-family:var(--font-ui);font-size:.64rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(244,234,217,.45)">
...
export function buildHomeHtml(hero: HeroCopy): string {
  return homeHtmlTemplate
    .replaceAll(HERO_EYEBROW, hero.eyebrow)
    .replaceAll(HERO_TITLE, hero.titleHtml)
    .replaceAll(HERO_BODY, hero.body);
}

export const homeHtml = buildHomeHtml(HERO_COPY);
